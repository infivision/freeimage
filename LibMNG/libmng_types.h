...
#define _WIN32                          /* gather them into a single define */
#endif
#endif
...
#ifdef _WIN32                           /* only include needed stuff */
...
#if defined(MNG_DLL) && defined(_WIN32) /* setup DLL calling conventions */ 
